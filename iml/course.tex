...
Large and heterogeneous data can be made compact and homogeneous via BoW. The resulting reprensentations can be directly used as input to any ML algorithm.
